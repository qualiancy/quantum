...
utils.parseMessage = function(ev, fn) {
  var data = ev._;
  var msg = ev.msg;
  var tokens = ev.tokens;
  msg = utils.parseValues(msg, data);
  msg = utils.parseTokens(msg, tokens);
  msg = utils.parseFormat(msg, fn);
  return msg;
};

utils.parseValues = function(msg, data) {
...
utils.parseTokens = function(msg, tokens) {
...
utils.parseFormat = function(msg, fn) {
